...
const getTool = (req, res) => {
    ...
    let query = `select t.tool_id, t.tool_name, t.price, t.description, t.make, t.model_name,
     t.suggested_project, t.tool_condition, tcd.contact_name, tcd.email, tcd.address, tcd.city, tcd.state,
      tcd.zipcode, tcd.contact_number from tool t, tool_contact_details tcd where 
